...
public class AppLogEntity {
    ...
    @ColumnInfo(name = "menu") public String menu;
    @ColumnInfo(name = "entity") public String entity;
    @ColumnInfo(name = "message") public String message;
    @ColumnInfo(name = "user_id") public String userId;
    @ColumnInfo(name = "request_api") public String requestApi;
    @ColumnInfo(name = "response_api") public String responseApi;
    @ColumnInfo(name = "device") public String device;
}
